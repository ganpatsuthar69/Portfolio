    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 bg-gradient-to-br from-white via-neutral-50 to-white dark:from-background dark:via-background dark:to-background">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <motion.div
          ...
          transition={{ duration: 15, repeat: Number.POSITIVE_INFINITY, repeatType: "mirror", delay: 1 }}
      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* NAME (Main Focus) */}
            <motion.h1
              className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tight mb-6 flex flex-wrap justify-center lg:justify-start"
            >
            ...
            {/* SUB HEADLINE (Distinct but Clean) */}
            <motion.h2
              variants={itemVariants}
            ...
            >
              Building <span className="text-neutral-600 dark:text-foreground/80">Scalable Systems</span> <br className="hidden lg:block" /> & <span className="text-neutral-600 dark:text-foreground/80">User Experiences</span>
            </motion.h2>
            ...
            >
              Full Stack Developer focused on Clean Architecture and Building Scalable Real-world Software.
            </motion.p>
          ...
          >
            <div className="relative w-72 h-72 sm:w-96 sm:h-96 lg:w-[30rem] lg:h-[30rem]">
              ...
              {/* Static Glow Base with faster pulse */}
              <motion.div
